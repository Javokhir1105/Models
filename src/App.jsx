...
function App() {
  ...
  // model api
  const [modelxon, setModelxon] = useState([]);
  ...
  const getApiModel = () => {
    fetch('https://autoapi.dezinfeksiyatashkent.uz/api/brands')
      ...
      .then((item) => setModelxon(item.data))
  };
  useEffect(() => {
    getApiModel()
  }, [])
  ...
  const putBtn = (e) => {
    ...
    formData.append('brand_id', brandidEdit);
    fetch(`https://autoapi.dezinfeksiyatashkent.uz/api/models/${clickId}`, {
      method: "PUT",
      body: formData,
      headers: {
        ...
        <Modal title="Basic Modal" open={isModalOpen} onOk={handleOk} onCancel={handleCancel}>
          {
            clickAdd
              ...
              <form style={{ justifyContent: "center" }}>
                ...
                <select onChange={(e) => setbrandidEdit(e.target.value)}>
                  {modelxon.map((item, i) => (
